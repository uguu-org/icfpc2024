...
run_test $LINENO 'B& T F' 'F'
run_test $LINENO 'B. S4% S34' 'test'
run_test $LINENO 'BT I$ S4%34' 'tes'
run_test $LINENO 'BD I$ S4%34' 't'

run_test $LINENO '? B> I# I$ S9%3 S./' 'no'
run_test $LINENO '? B< I# I$ S9%3 S./' 'yes'

run_test $LINENO 'B$ L" B+ v" v" B* I$ I#' '12'
run_test $LINENO 'B$ L# B$ L" B+ v" v" B* I$ I# v8' '12'
run_test $LINENO 'B$ L$ I$ I#' '3'
run_test $LINENO 'B$ B$ L# L$ v# B. SB%,,/ S}Q/2,$_ IK' 'Hello World!'
